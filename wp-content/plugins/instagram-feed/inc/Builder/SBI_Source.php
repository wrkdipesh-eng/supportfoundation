...
class SBI_Source
{
	...
	public static function process_connecting_source_data($source_data)
	{
		...
		if (!empty($single_source['error'])) {
			...
			$message .= ' <a href="https://smashballoon.com/instagram-feed/docs/errors/?utm_campaign=instagram-free&utm_source=customizer&utm_medium=docs" target="_blank" rel="noopener">' . __('Directions on how to resolve this issue', 'instagram-feed') . '</a>';
