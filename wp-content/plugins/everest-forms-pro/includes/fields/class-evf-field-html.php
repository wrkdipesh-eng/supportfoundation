...
class EVF_Field_HTML extends EVF_Form_Fields {
	...
	public function __construct() {
		$this->name     = esc_html__( 'Custom HTML', 'everest-forms-pro' );
		$this->type     = 'html';
	...
	public function field_preview( $field ) {
		...
		<div class="code-block">
			<label class="label-title"> <i class="fa fa-code"></i> <?php esc_html_e( 'HTML / Code Block', 'everest-forms-pro' ); ?></label>
			<div class="description"><?php esc_html_e( 'Contents of this field are not displayed in the admin area.', 'everest-forms-pro' ); ?></div>
		</div>
		<?php
	}
