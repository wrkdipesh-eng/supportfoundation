...
class EVF_Field_Privacy_Policy extends EVF_Form_Fields {
	...
	public function __construct() {
		$this->name     = esc_html__( 'Privacy Policy', 'everest-forms-pro' );
	...
	public function consent_message( $field ) {
		$label       = $this->field_element(
			...
			array(
				...
				'value'   => esc_html__( 'Consent Message', 'everest-forms-pro' ),
				'tooltip' => esc_html__( 'Enter a message for user consentment.', 'everest-forms-pro' ),
			),
			false
		);
		...
		printf(
			...
			esc_html__( 'Note', 'everest-forms-pro' ),
			esc_html__( 'Please use syntax', 'everest-forms-pro' ),
			esc_html__( 'Link Label', 'everest-forms-pro' ),
			esc_html__( 'Link URL', 'everest-forms-pro' ),
			esc_html__( 'to create a hyperlink', 'everest-forms-pro' )
		);
	}
	...
	public function add_custom_link( $field ) {
		...
		$this->field_element(
			...
			array(
				...
				'value'   => esc_html__( 'Add a custom URL', 'everest-forms-pro' ),
				'tooltip' => esc_html__( 'Add a custom URL, containing policy details, in the consent message.', 'everest-forms-pro' ),
			)
		);
		...
		printf(
			...
			esc_html__( 'Add Custom URL', 'everest-forms-pro' )
		);
		echo '</div>';
		$this->field_element(
			'row',
	...
	public function add_local_page( $field ) {
		...
		$label       = $this->field_element(
			...
			array(
				'slug'    => 'add_local_page',
				'value'   => esc_html__( 'Add a local Privacy Policy page', 'everest-forms-pro' ),
				'tooltip' => esc_html__( 'Add a local page residing in your site, containing policy details, in the consent message.', 'everest-forms-pro' ),
			),
			false
		);
		$input_field = $this->field_element(
		...
		$add_button  = sprintf(
			...
			esc_html__( 'Add page', 'everest-forms-pro' )
		);
		$this->field_element(
			'row',
			$field,
