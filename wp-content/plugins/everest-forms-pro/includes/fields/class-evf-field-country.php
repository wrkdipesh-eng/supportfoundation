...
class EVF_Field_Country extends EVF_Form_Fields {
		...
		$fld = $this->field_element(
			...
			array(
				...
				'data'     => array(
					...
					'placeholder'             => __( 'Select Country(s)', 'everest-forms-pro' ),
					'selected_msg'            => __( 'Selected %qty% Country(s)', 'everest-forms-pro' ),
				),
			),
			false
		);
	...
	public function field_preview( $field ) {
		...
		if ( empty( $default ) ) {
			printf( '<option value="" class="placeholder" selected>%s</option>', ! empty( $field['placeholder'] ) ? esc_html( $field['placeholder'] ) : esc_html__( '--- Select a country ---', 'everest-forms-pro' ) );
		}
	...
	public function field_display( $field, $field_atts, $form_data ) {
		...
		if ( count( $countries ) ) {
			...
			printf( '<option value="" class="placeholder" disabled selected>%s</option>', ! empty( $field['placeholder'] ) ? esc_attr( $field['placeholder'] ) : esc_html__( '--- No countries to select ---', 'everest-forms-pro' ) );
		}
