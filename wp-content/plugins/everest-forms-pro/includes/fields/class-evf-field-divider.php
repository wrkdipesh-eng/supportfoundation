...
class EVF_Field_Divider extends EVF_Form_Fields {
	...
	public function __construct() {
		$this->name     = __( 'Divider', 'everest-forms-pro' );
		$this->type     = 'divider';
	...
	public function divider_type( $field ) {
		$lbl  = $this->field_element(
			...
			array(
				'slug'    => 'divider_type',
				'value'   => esc_html__( 'Divider Type', 'everest-forms-pro' ),
				'tooltip' => sprintf( esc_html__( 'Select the type of seperator displayed on frontend.', 'everest-forms-pro' ) ),
			),
			false
		);
		$fld  = $this->field_element(
			...
			array(
				...
				'options' => array(
					'default' => esc_html__( 'Plain', 'everest-forms-pro' ),
					'dashed'  => esc_html__( 'Dashed', 'everest-forms-pro' ),
					'dotted'  => esc_html__( 'Dotted', 'everest-forms-pro' ),
					'thick'   => esc_html__( 'Thick', 'everest-forms-pro' ),
					'double'  => esc_html__( 'Double', 'everest-forms-pro' ),
				),
			),
			false
		);
