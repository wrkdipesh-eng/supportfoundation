...
class EVF_Field_Rating extends EVF_Form_Fields {
	...
	public function __construct() {
		$this->name     = esc_html__( 'Rating', 'everest-forms-pro' );
		$this->type     = 'rating';
	...
	public function number_of_stars( $field ) {
		...
		$lbl = $this->field_element(
			...
			array(
				...
				'value'   => esc_html__( 'Number of Icons', 'everest-forms-pro' ),
	...
	public function rating_icon( $field ) {
		...
		$lbl  = $this->field_element(
			...
			array(
				'slug'    => 'rating-icon',
				'value'   => esc_html__( 'Rating Icon', 'everest-forms-pro' ),
				'tooltip' => esc_html__( 'Select rating icon to display', 'everest-forms-pro' ),
			),
			false
		);
	...
	public function icon_color( $field ) {
		...
		$lbl = $this->field_element(
			...
			array(
				'slug'    => 'icon_color',
				'value'   => esc_html__( 'Icon Color', 'everest-forms-pro' ),
				'tooltip' => esc_html__( 'Select the primary color for the rating icon', 'everest-forms-pro' ),
			),
			false
		);
		$fld = $this->field_element(
