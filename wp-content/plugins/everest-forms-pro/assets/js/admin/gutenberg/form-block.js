	 ...
	 edit( props ) {
		 ...
		 jsx = [
			 <InspectorControls key="evf-gutenberg-form-selector-inspector-controls">
				 ...
				 {displayPopupType === "popup-link" || displayPopupType === "popup-button" ? [
					<TextControl
					key="evf-gutenberg-form-selector-text"
					label={displayPopupType === "popup-link" ? "Link Text" : "Button Text" }
